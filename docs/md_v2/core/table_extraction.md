...
If you're already using Crawl, nothing changes:
...
```python
from crawl import DefaultTableExtraction, CrawlerRunConfig
...
```python
from crawl import LLMTableExtraction, LLMConfig, CrawlerRunConfig
...
```python
from crawl import NoTableExtraction, CrawlerRunConfig
...
```python
from crawl import TableExtractionStrategy
...
Table extraction works seamlessly with other Crawl strategies:
