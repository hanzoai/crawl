# Crawl 0.4.3: Major Performance Boost & LLM Integration

We're excited to announce Crawl 0.4.3, focusing on three key areas: Speed & Efficiency, LLM Integration, and Core Platform Improvements. This release significantly improves crawling performance while adding powerful new LLM-powered features.
...
```python
from crawl import AsyncWebCrawler, CrawlerRunConfig, DisplayMode
from crawl.async_dispatcher import MemoryAdaptiveDispatcher, CrawlerMonitor
...
For complete examples, check our [demo repository](https://github.com/hanzoai/crawl/examples).

## Stay Connected

- Star us on [GitHub](https://github.com/hanzoai/crawl)
- Follow [@unclecode](https://twitter.com/unclecode)
- Join our [Discord](https://discord.gg/crawl)
