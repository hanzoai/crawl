# Crawl v0.6.0 Release Notes

We're excited to announce the release of **Crawl v0.6.0**, our biggest and most feature-rich update yet. This version introduces major architectural upgrades, brand-new capabilities for geo-aware crawling, high-efficiency scraping, and real-time streaming support for scalable deployments.
...
This is a major step towards making Crawl real-time ready.
...
- Legacy `crawl/browser/*` modules are removed. Update imports accordingly.
...
If you're new to Crawl, start here:
