...
class LXMLWebScrapingStrategy(ContentScrapingStrategy):
    ...
    This is the primary scraping strategy in Crawl, providing high-performance
    ...
    def _scrap(
        ...
        **kwargs,
        ...
        try:
            ...
            error_div = etree.SubElement(error_body, "div", id="crawl_error_message")
            error_div.text = f"""
            Crawl Error: This page is not fully supported.
