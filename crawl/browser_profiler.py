...
that can be used for identity-based crawling with Crawl.
"""
...
class BrowserProfiler:
    """
    A dedicated class for managing browser profiles for Crawl.
    ...
    Profiles are stored by default in ~/.crawl/profiles/
    """
    ...
    async def create_profile(
        ...
        self.logger.info("4. The profile will be saved and ready to use with Crawl.", tag="PROFILE")
    ...
    def delete_profile(self, profile_name_or_path: str) -> bool:
        ...
        Example:
            ...
            # Delete by path
            success = profiler.delete_profile("/path/to/.crawl/profiles/my-profile")
            ```
        """
...
if __name__ == "__main__":
    ...
    from pathlib import Path
    home_dir = Path.home()
    profile_path = asyncio.run(profiler.create_profile( str(home_dir / ".crawl/profiles/test-profile")))
