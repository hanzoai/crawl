...
# --- Test Configuration ---
BASE_URL = os.getenv("CRAWL_TEST_URL", "http://localhost:11235") # If server is running in Docker, use the host's IP
BASE_URL = os.getenv("CRAWL_TEST_URL", "http://localhost:8020") # If server is running in dev debug mode
DEEP_CRAWL_BASE_URL = "https://docs.hanzo.ai/samples/deepcrawl/"
DEEP_CRAWL_DOMAIN = "docs.hanzo.ai" # Used for domain filter
