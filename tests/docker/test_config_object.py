...
from crawl.deep_crawling.filters import FastFilterChain
from crawl.deep_crawling.filters import FastContentTypeFilter, FastDomainFilter
from crawl.deep_crawling.scorers import FastKeywordRelevanceScorer
