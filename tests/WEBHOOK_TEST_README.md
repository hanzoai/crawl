...
5. ✅ Starts Crawl server in background
...
- Starts Crawl server on port 11235
...
[INFO] Project root: /path/to/crawl
...
1. Check server logs: `/tmp/crawl_server.log`
...
- `/tmp/crawl_server.log` - Server output logs
...
2. Review server logs at `/tmp/crawl_server.log`
