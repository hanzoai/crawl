#!/usr/bin/env python3
"""
Benchmark reporting tool for Crawl stress tests.
...
class BenchmarkReporter:
    """Generates visual reports and comparisons for Crawl stress tests."""
    ...
    def generate_summary_table(self, results):
        ...
        Returns:
            Rich Table object
        """
        table = Table(title="Crawl Stress Test Summary", show_header=True)
    ...
    def generate_performance_chart(self, results, output_file=None):
        ...
        plt.title('Crawl Performance Benchmarks')
        plt.tight_layout()
    ...
    def generate_comparison_report(self, results, title=None, output_file=None):
        ...
        html.append(f'<title>{title or "Crawl Benchmark Comparison"}</title>')
        html.append('<style>')
        html.append('''
        body {
        ...
        # Header
        html.append(f'<h1>{title or "Crawl Benchmark Comparison"}</h1>')
        html.append(f'<p>Report generated on {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>')
        
        # Summary section
        html.append('<div class="card">')
        html.append('<h2>Summary</h2>')
        html.append('<p>This report compares the performance of Crawl across multiple test runs.</p>')
        ...
        html.append('<p>Generated by Crawl Benchmark Reporter</p>')
        html.append('</div>')
    ...
    def run(self, limit=None, output_file=None):
        ...
        title = f"Crawl Benchmark Report ({len(results)} test runs)"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate benchmark reports for Crawl stress tests")
